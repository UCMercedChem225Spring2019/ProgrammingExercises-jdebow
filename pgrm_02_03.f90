...
! 
!     In the SSPEV subroutine, the first character can be N or V, where
!     V is the correct value as it computes both eigenvalues and
!     eigenvectors. The second character can be U or L, where L is the
!     correct character in the lower-triangle.
!
...
!     Array_Input.
!
!     Column-wise lower-traingle symmetric packed form.
!
      k=0
      do i=1,N
      do j=i,N
